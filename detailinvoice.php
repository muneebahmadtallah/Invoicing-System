...
<div class="form-group row">
  ...
  <div class="col-sm-9">
    <input type="text" class="form-control" name="invoice_no" value="<?php echo $data['invoice_no'] ?>" >
  </div>
</div>
</div>
...
<div class="form-group row">
  ...
  <div class="col-sm-10">
    <input type="date" value="<?php echo $data['date'] ?>" name="date" class="form-control">
  </div>
</div>
</div>
</div>
...
<div class="form-group row">
  ...
  <div class="col-sm-9">
      <input type="text" class="form-control" name="user_name" id="uname" value="<?php echo $data['name'] ?>"> 
...
<?php  
 ...
 if(mysqli_num_rows($result2) > 0)
 {
  ...
  <tr>
    ...
    <td>
    <input type="text" class="form-control pname" name="title[]" value="<?php echo $data2["title"] ?>">
      <input type="hidden" name="product_id" value="<?php echo $data2["product_id"] ?>">
    <div class="pnamelist"></div>
    </td>
    <td>
    <input type="text" class="form-control ItemPrice" name="ItemPrice[]" value="<?php echo $data2["ItemPrice"] ?>"></td>
    <td>
    
    <input type="text" class="form-control PercentPrice" name="PercentPrice[]" value="<?php echo $data2["PercentPrice"] ?>"></td>
    <td>
    <input type="text" class="form-control Quantity" name="Quantity[]" value="<?php echo $data2["Quantity"] ?>"></td>
    <td>
    <input type="text" class="form-control SubTotal" name="SubTotal[]" value="<?php echo $data2["SubTotal"] ?>"></td>
    <td>
...
<div class="form-group row">
  ...
  <div class="col-sm-8">
    <input type="text" name="GrossTotal" class="form-control" id="GrossTotal" value="<?php echo $data['GrossTotal'] ?>">
  </div>
</div>
</div>
</div>
...
<div class="form-group row">
  ...
  <div class="col-sm-8">
    <input type="text" name="NetTotal" id="NetTotal" class="form-control" value="<?php echo $data['NetTotal'] ?>">
  </div>
</div>
</div>
</div>
